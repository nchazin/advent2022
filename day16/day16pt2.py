...
def move(cur_node, prev_node, cur_total, cur_flow_enabled, valves_on, visited, tick):
    global max_answer, total_calls, answers_too_far, g_visited
...
move("AA", None, 0, 0, g_visited, (), 1)
print(max_answer)
print(max_answer + pt1_sum)
